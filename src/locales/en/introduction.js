export default {
    ...
    'data': [
        ...
        'I have published several papers in top-tier conferences such as <span class="highlight-red">CVPR</span>, <span class="highlight-red">ICCV</span>, and <span class="highlight-red">ICRA</span>. My open-source datasets have been downloaded over <span class="highlight-red">4,000,000</span> times, and I have served as a reviewer for international conferences like <span class="highlight-red">NeurIPS</span> and <span class="highlight-red">BMVC</span>.',
